        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-16">
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link href="/brand-voice-generator" className="font-mono text-xs text-graphite hover:text-ink transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-1">Brand Voice Generator</Link>
