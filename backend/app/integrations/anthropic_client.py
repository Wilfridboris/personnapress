...
from app.services.angles import ANGLE_LABELS, KNOWN_CODES, fallback_angles, _LINKEDIN_ORDER, _X_ORDER, _FACEBOOK_ORDER, _INSTAGRAM_ORDER
...
async def _repair_post(platform: str, text: str, caller: str) -> str:
    ...
    try:
        repaired = await _call(repair_prompt, max_tokens=2048)
